...
<?php
    ...
    $collec_this = stats_collections($pdoConnection, $time_ft);
?>
...
<div class="display-flex align-items-center parent-box-input-check-floor-price supper-parent-box-input-check-floor-price flex_responsive_duythai bottom_responsive1_duythai">
    <div class="taphop-time-btn-filter display-flex align-items-center bottom_responsive_duythai ">
        <button id="btn_collec_hour_explore" class="btn-destroy time-btn-filter-at-trending-collections-at-page-home padding_responsive_duythai peric_ft_collections">1G</button>
        <button id="btn_collec_day_explore" class="btn-destroy time-btn-filter-at-trending-collections-at-page-home box-input-bg-color-white padding_responsive_duythai peric_ft_collections">1N</button>
        <button id="btn_collec_week_explore"  class="btn-destroy time-btn-filter-at-trending-collections-at-page-home padding_responsive_duythai peric_ft_collections">7D</button>
        <button id="btn_collec_30days_explore" class="btn-destroy time-btn-filter-at-trending-collections-at-page-home padding_responsive_duythai peric_ft_collections">30N</button>
    </div>
...
<!-- ========================================================================== -->
<div id="container_collectiond_explore" class="new-collections-page-home all-collections-rank-trending-at-page-home huyborder_responsive_duythai">
    ...
    <?php
        ...
        if (is_array($collec_this) && !empty($collec_this)){
            ...
            echo '<div style="text-align:center; padding: 50px 0; color:grey;">Hãy thêm một vài bộ sưu tập nhé!</div>';
        }
    ?>
</div>
