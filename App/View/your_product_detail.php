...
if (!empty($_GET['pro_dt_id_khach'])) {
    $my_pro_id = $_GET['pro_dt_id_khach'];
            ...
            <div class="width-30phantram combo-thanh-ben-parent-children-1">
                ...
                <div class="width-100phantram">
                    <div class="padding-22px-24px combo-border-xam-items">
                        ...
                        <input class="khach_idpro" type="hidden" value="<?php echo $my_info_pr['ProductID']; ?>">
                        <input class="khach_namepr" type="hidden" value="<?php echo $my_info_pr['Name']; ?>">
                        <input class="khach_username" type="hidden" value="<?php echo $my_info_pr['Username']; ?>">
                        <input class="khach_namecate" type="hidden" value="<?php echo $my_info_pr['namecate']; ?>">
                        <input class="khach_price" type="hidden" value="<?php echo $my_info_pr['ListedPrice']; ?>">
                        <input class="khach_img" type="hidden" value="<?php echo IMAGE_PATH.$my_info_pr['ImageURL']; ?>">

                        <div class="display-flex align-items-center justify-content-space-between colmn-gap-10px" >
                            <button style="display: <?php echo $anflase ?>;" class="pg-detail-buy-product-with-price-this text-white display-flex align-items-center justify-content-center width-100phantram "><div>Chưa mở bán</div></button>
                            <button id="add_hoadon_details" style="display: <?php echo $an ?>;" class="pg-detail-buy-product-with-price-this text-white display-flex align-items-center justify-content-center width-100phantram "><div>Mua ngay</div></button>
                            <button id="add_cart_details" style="display: <?php echo $an ?>;" class="btn-destroy pg-detail-add-to-cart text-white display-flex align-items-center"><i class='bx bx-plus'></i></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="padding-left-right-39px display-flex justify-content-center margin-bot-20px">
           ...
           <div class="display-flex align-items-center margin-bottom-30px">
                ...
                if (isset($_SESSION["iduser"], $_SESSION["avatarus"], $_SESSION['Username'])){
                    ...
                    echo '<a href="index.php?act=login" class="box_lg_for_cmt"><button class="dangnhapdebinhluan">Đăng nhập để bình luận</button></a>';
                }
...
<script src="<?php echo SITE_SCRIPT_PATH; ?>shoppinh_detail.js"></script>
