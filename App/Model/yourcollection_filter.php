...
function filterProducts($collection, $trend, $minPrice, $maxPrice,
$priced, $unpriced, $images, $video, $sound, $price_desc, $price_asc, $conn){
    ...
    WHERE 1
    AND `collections`.`CollectionID` = :collection
    ";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    ...
    $exPro = filterProducts($collection, $trend, $minPrice, $maxPrice,
...
if (is_array($exPro) && !empty($exPro)) {
    ...
    echo '<div style="text-align:center; padding: 50px 0; color:grey; width:100%;">Chưa có sản phẩm nào!</div>'.$collection.'';
}
