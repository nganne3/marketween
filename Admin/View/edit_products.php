        ...
        <?php endif; unset($_SESSION['loi']); ?>
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card bg-gradient-primary text-white">
                    <div class="card-body">
                    <form class="editProduct" action="index.php?actad=edit_product&ProductID=<?php echo htmlspecialchars($_GET['ProductID']); ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="ProductID" value="<?php echo isset($_GET['ProductID']) ? htmlspecialchars($_GET['ProductID']) : ''; ?>">
                            <div class="forms-sample">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="Name">Tên sản phẩm</label>
                                    <input type="text" class="form-control" id="Name" name="Name" value="<?php echo isset($editproduct['Name']) ? $editproduct['Name'] : ''; ?>">
                                    <?php echo isset($NameError) ? '<div style="color: orange;">' . $NameError . '</div>' : ''; ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ListedPrice">Giá</label>
                                    <input type="text" class="form-control" id="ListedPrice" name="ListedPrice" value="<?php echo isset($editproduct['ListedPrice']) ? $editproduct['ListedPrice'] : ''; ?>">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea id="Description" name="Description" rows="7" class="w-100" style="border-radius: 10px; border: none; padding: 10px 15px;"><?php echo isset($editproduct['Description']) ? $editproduct['Description'] : ''; ?></textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="text-center">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <img id="image-preview" src="<?php echo PRODUCT_PATH; ?><?=$editproduct['ImageURL']?>"
